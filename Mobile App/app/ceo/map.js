    ...
    const interval = setInterval(() => {
      setTrucks(prevTrucks =>
        prevTrucks.map(truck => {
          ...
          const progress = truck.routeProgress + 0.008; // Slower movement for better UX
  ...
  const TruckMarker = ({ truck }) => (
    ...
    >
      <View style={styles.markerContainer}>
        <View style={[
          styles.markerPulse, 
          { backgroundColor: `${truckColors[truck.type]}20` }
        ]} />
        <View style={[
          styles.markerInner, 
          { backgroundColor: truckColors[truck.type] }
        ]}>
          <Image
    ...
    <View style={styles.infoCard}>
      <View style={styles.infoHeader}>
        ...
        <View style={styles.statusContainer}>
          <Ionicons 
            name={getStatusIcon(truck.status)} 
            size={16} 
    ...
    <View style={styles.container}>
      ...
      >
        {trucks.map(truck => (
          <React.Fragment key={truck.id}>
            ...
            {showRoutes && truck.route.length > 1 && (
              <Polyline
                coordinates={truck.route}
                strokeColor={truckColors[truck.type]}
                strokeWidth={4}
                strokeColors={[truckColors[truck.type]]}
      ...
      <View style={styles.controlPanel}>
        <TouchableOpacity 
          ...
          onPress={() => setShowTruckList(!showTruckList)}
        >
        ...
        >
          <Ionicons 
            name={mapType === 'standard' ? "earth" : "earth-outline"} 
            size={24} 
            color="#374151" 
          />
        </TouchableOpacity>
      ...
      >
        <View style={styles.panelHeader}>
          ...
          <TouchableOpacity 
            ...
            onPress={() => setShowTruckList(false)}
          >
